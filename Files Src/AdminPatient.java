 ...
 public void RBed(){
    try {
        ...
        while(rs.next()) {
            ...
            RecRoom.addItem(new AdminPatient.Bed(rs.getString(1)));
        } 
    ...
    String vaccinedetail = ADPtable.getValueAt(r,7).toString();
    String vaccinetype = ADPtable.getValueAt(r,8).toString();
    
    String gender = ADPtable.getValueAt(r,5).toString();
    String admitdate = ADPtable.getValueAt(r,9).toString();
    String room = ADPtable.getValueAt(r,10).toString();
        ...
        ADadmitdate.setText(admitdate);
        RecRoom.setSelectedItem(room);
    ...
    try {
     ...
     public void update(){
        String id,fname,lname,address,gender,detailvaccine,vaccinetype,age,mnum,admit,room;
        ...
        admit = ADadmitdate.getText();
        room = RecRoom.getSelectedItem().toString();
        
        try {
            Class.forName("java.sql.Driver");
            Connection con = DriverManager.getConnection ("jdbc:mysql://localhost:3306/hospitalmanagementsystem","root","");

            String sql = "UPDATE admin_patient SET pid ='"+id+"',pfname ='"+fname+"',plname ='"+lname+"',paddress ='"+address+"',page  ='"+age+"',pgender  ='"+gender+"',pmobilenumber  ='"+mnum+"',pvaccinedetail  ='"+detailvaccine+"',pvaccinetype  ='"+vaccinetype+"',admitdate  ='"+admit+"',proom  ='"+room+"' WHERE pid ='"+id+"'" ; 
            pst = con.prepareStatement(sql);
            pst.executeUpdate();
   ...
   if (check == 0){
    ...
    try {
        ...
        ADPid.setText("P0001");
            ...
            id++;
            ADPid.setText("P"+ String.format("%04d", id));
    ...
    private void initComponents() {
        ...
        ADadmitdate = new javax.swing.JTextField();
        ...
        ADadmitdate.setBackground(new java.awt.Color(108, 122, 137));
        ADadmitdate.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        ADadmitdate.setForeground(new java.awt.Color(255, 255, 255));
        jPanel3.add(ADadmitdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 190, 210, 30));

        jLabel19.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel19.setForeground(new java.awt.Color(255, 255, 255));
        jLabel19.setText("Admit Date       :");
        jPanel3.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 190, 140, 30));
        ...
        jPanel3.add(RecRoom, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 230, 140, 30));
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 200, 1000, 290));
        ...
        ADPtable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Patient ID", "First Name", "Last Name", "Address", "Age", "Gender", "Mobile Number", "Get Vaccined", "Vaccine Type", "Admit Date", "Room"
            }
        ));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 530, 1190, 180));
    ...
    private void ADPaddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ADPaddActionPerformed
        String id,fname,lname,address,gender,detailvaccine,vaccinetype,age,mnum,admitdate,room;
        ...
        try {
            ...
            String sql = "INSERT INTO admin_patient(pid,pfname,plname,paddress,page,pgender,pmobilenumber,pvaccinedetail,pvaccinetype,admitdate,proom) VALUES ('"+id+"','"+fname+"','"+lname+"','"+address+"','"+age+"','"+gender+"','"+mnum+"','"+detailvaccine+"','"+vaccinetype+"','"+admitdate+"','"+room+"')";
            pst = con.prepareStatement(sql);
            pst.execute();
    ...
    private javax.swing.JTextField ADadmitdate;
